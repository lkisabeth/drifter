...
public protocol DriftChatViewControllerDelegate: NSObjectProtocol {
...
open class DriftChatViewController: BaseChatViewController {
    ...
    open override func viewDidLoad() {
        ...
        updateTitleView(title: "Drift Chat", subtitle: "Testing")
    }
...
extension DriftChatViewController: MessagesDisplayDelegate {
    // MARK: - Text Messages
...
extension DriftChatViewController: MessagesLayoutDelegate {
...
extension DriftChatViewController: MessageInputBarDelegate {
